...
export function OrganizersStrip() {
  return (
    <section className="border-b border-border/60 bg-background py-8 md:py-10">
      <div className="container mx-auto max-w-6xl px-4 md:px-6">
        <p className="text-center text-xs font-medium uppercase tracking-wider text-muted-foreground">
          Convened by
        </p>
        <div className="mt-6 grid grid-cols-2 items-center justify-items-center gap-x-6 gap-y-6 sm:grid-cols-4 md:gap-x-10">
